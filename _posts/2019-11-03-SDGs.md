...
### The table below shows the data that makes the plot above 
#### SDGs with more related Drawdown Solutions appear in columns towards                                                 the left of the table
...
<div style="border: 1px solid #ddd; padding: 0px; overflow-y: scroll; height:300px; overflow-x: scroll; width:600px; "><table class="table table-striped" style="margin-left: auto; margin-right: auto;">
 <thead>
  <tr>
